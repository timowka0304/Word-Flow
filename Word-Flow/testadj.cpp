    ...
    ui(new Ui::TestAdj)
{
    ...
    QPixmap myPixmap(":/new/prefix1/res/prilag.jpg");
...
void TestAdj::ResultShow(){
    ...
    ui->msg_text->setText(QString("Вы верно ответили на %1 из 10\nВы успешны в запоминании прилагательных на %2%").arg(sum).arg(sum*10));
}
...
void TestAdj::on_done_Button_clicked()
{
    ...
    QSqlQuery query;
    query.exec(QString("INSERT INTO Progress VALUES (%1, %2, 10, 'Прилагательные')").arg(sum*10).arg(sum));
