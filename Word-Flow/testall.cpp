    ...
    ui(new Ui::TestAll)
{
    ...
    QPixmap myPixmap(":/new/prefix1/obsch.jpg");
...
void TestAll::FillStart(){
    srand(time(nullptr));
    for(int i = 0; i < 10; i++){
        numbers_words[i].question_number = rand() % 2 + 1;
    }
    for(int i = 0; i < 10; i ++){
        numbers_words[i].word_answer_number = rand() % 300 + 1;
        for(int j = 0; j < i; j ++){
    ...
    for(int i = 0; i < 10; i++){
        numbers_words[i].word_1_number = rand() % 300 + 1;
        for(int j = 0; j < 10; j ++){
    ...
    for(int i = 0; i < 10; i++){
        numbers_words[i].word_2_number = rand() % 300 + 1;
        for(int j = 0; j < 10; j ++){
    ...
    for(int i = 0; i < 10; i++){
        numbers_words[i].word_3_number = rand() % 300 + 1;
        for(int j = 0; j < 10; j ++){
...
void TestAll::on_start_Button_clicked()
{
    srand(time(nullptr));
    QMessageBox msgBox;
...
void TestAll::on_back_to_menu_Button_clicked()
{
    this->close();
    emit AllMenu();
}

void TestAll::on_next_Button_clicked()
{
    QButtonGroup group;
...
void TestAll::Warning(int flag, QString eng, QString rus){
    QMessageBox msgBox;
