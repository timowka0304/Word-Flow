    ...
    ui(new Ui::Random)
{
    ...
    QPixmap myPixmap(":/new/prefix1/susch.jpg");
...
void Random::ResultShow(){
    ...
    ui->msg_text->setText(QStringLiteral("Вы верно ответили на %1 из 10\nВы успешны в запоминании сущестительных на %2%").arg(sum).arg(sum*10));
}
...
void Random::on_done_Button_clicked()
{
    ...
    QSqlQuery query;
    query.exec(QStringLiteral("INSERT INTO Progress VALUES (%1, %2, 10, 'Существительные')").arg(sum*10).arg(sum));
