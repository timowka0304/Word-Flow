...
public:
    ...
    void setupUi(QDialog *Random)
    {
        ...
        layoutWidget->setGeometry(QRect(6, 21, 541, 201));
        ...
        msg_text = new QLabel(layoutWidget);
        ...
        layoutWidget1->setGeometry(QRect(20, 30, 551, 97));
        ...
        mark_text = new QLabel(layoutWidget1);
