...
#include "../Word-Flow/progresswindow.h"
...
QT_MOC_LITERAL(1, 15, 8), // "MainMenu"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 30) // "on_back_to_menu_Button_clicked"

    },
    "ProgressWindow\0MainMenu\0\0"
...
void ProgressWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_back_to_menu_Button_clicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProgressWindow::MainMenu)) {
                *result = 0;
                return;
            }
        }
